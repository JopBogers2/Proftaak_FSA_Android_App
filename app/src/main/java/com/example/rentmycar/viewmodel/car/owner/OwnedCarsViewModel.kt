                    ...
                    .addOnSuccessListener { location ->
                        if (location != null) {
                            viewModelScope.launch {
                                ...
                                Log.d(
                                    "UserCarsViewModel",
                                    "Adding location for car $carId: $latitude, $longitude"
                                )
                                ...
                                result.onSuccess {
                                    Log.d(
                                        "UserCarsViewModel",
                                        "Location added successfully for car $carId"
                                    )
                                    getUserCars()
                                }.onFailure { error ->
                                    Log.e(
                                        "UserCarsViewModel",
                                        "Failed to add location for car $carId",
                                        error
                                    )
                                    _viewState.value =
        ...
        viewModelScope.launch {
            try {
                ...
                result.onSuccess { images ->
                    ...
                    Log.e(
                        "UserCarsViewModel",
                        "Error fetching images for car $carId: ${error.message}",
                        error
                    )
